...
function forPerformanceAnalysisDateMonth(viewData) {
    ...
    let _import = viewData.importData ? parseFloat(viewData.importData) : 0;
    ...
    let unforeseenLoss = ((devBplf - budgetSum) / (budCalc)) - ((actual_temperature_loss - budget_temperature_loss) * 100);
    let techLoss1 = 0;
    let moduleSum1 = 0;
    return {
        ...
        modgenSum: moduleSum,
        moduleSum1: parseFloat(techLoss1) + parseFloat(gfailure * 100) + parseFloat(soil * 100) + parseFloat(tilt * 100) + parseFloat(commission * 100) + parseFloat(dc * 100)
            + parseFloat(ac * 100) + parseFloat(invEffzncy * 100) + parseFloat(aux * 100) + parseFloat(transmission * 100),//(moduleSum * 100).toFixed(2),
        modrevSum: modrevSum,
        budgetSum: budgetSum,

        // (((this.state.performanceAnalysis.devBplf-this.state.performanceAnalysis.budgetSum)/(this.state.performanceAnalysis.budCalc))-
        // (this.state.performanceAnalysis.actual_temperature_loss-this.state.performanceAnalysis.budget_temperature_loss)*100)

        // unforeseenLoss: (devMgenplf - modgenSum),unforeseenLoss
        unforeseenLoss: parseFloat(parseFloat(devMgenplf - baux) - parseFloat(modgenSum)),
        // unforeseenLoss: unforeseenLoss.toFixed(2),
        unforeseenLoss1: (parseFloat(devMplf * 100) - (parseFloat(techLoss1) + parseFloat(gfailure * 100) + parseFloat(soil * 100) + parseFloat(tilt * 100) + parseFloat(commission * 100) + parseFloat(dc * 100) + parseFloat(ac * 100) + parseFloat(invEffzncy * 100) + parseFloat(aux * 100) + parseFloat(transmission * 100))).toFixed(2),
