...
class PunjabCurve extends Component {
    constructor(props) {
        super(props)
        this.state = {
    ...
    componentDidMount() {
        this.props.getMakeGraph({ pageID: 1, subPageID: 9 });
    }
                ...
                <Card style={{ maxWidth: "1264px", margin: "auto" }}>
                    ...
                    <Row>
                        <Col style={{ padding: "0.5%", paddingTop: "20px" }}>
                            ...
                            <legend className="boxShw" id="5dd212491cda8" style={{overflow:"hidden"}}>Punjab- 2MW - Rolling year.</legend>
                        ...
                        <Col style={{ padding: "0.5%", paddingTop: "20px" }}>
                            ...
                            <Card className="fieldset-chart">
                            <legend className="boxShw" id="5dd212491cda8" style={{overflow:"hidden"}}>Punjab- 2MW - MTD</legend>
                            <div style={{width:"95%",margin:"auto"}}>
                    ...
                    <Row>
                        <Col style={{ padding: "0.5%", paddingTop: "20px" }}>
                            ...
                            <Card className="fieldset-chart">
                            <legend className="boxShw" id="5dd212491cda8" style={{overflow:"hidden"}}>Voltage _Vanwala</legend>
                            <div style={{width:"95%",margin:"auto"}}>
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(PunjabCurve));
