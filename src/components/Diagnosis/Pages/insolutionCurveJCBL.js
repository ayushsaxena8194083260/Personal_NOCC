...
class InsolutionCurveJCBL extends Component {
    constructor(props) {
        super(props)
        this.state = {
    ...
    componentDidMount() {
        this.props.getMakeGraph({ pageID: 1, subPageID: 6  });
    }
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(InsolutionCurveJCBL));
