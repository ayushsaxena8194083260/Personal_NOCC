...
class InsolutionCurve extends Component {
    constructor(props) {
        super(props)
        this.state = {
                ...
                <Card style={{ maxWidth: "1264px", margin: "auto" }}>
                    ...
                    <Row>
                        <Col style={{ padding: "0.5%", paddingTop: "20px" }}>
                            ...
                            <legend className="boxShw" id="5dd212491cda8" style={{overflow:"hidden"}}>Insolation Curve_40MW Open</legend>
                            <div style={{width:"95%",margin:"auto"}}>
                                <InsolutionCurveChart {...this.state.gaugeGraphs0} {...defaultProps} index="0" />
                            </div>
                            </Card>
                        </Col>
                        <Col style={{ padding: "0.5%", paddingTop: "20px" }}>
                            ...
                            <Card className="fieldset-chart">
                            <legend className="boxShw" id="5dd212491cda8" style={{overflow:"hidden"}}>Insolation Curve_40MW DCR</legend>
                            <div style={{width:"95%",margin:"auto"}}>
                            <InsolutionCurveChart {...this.state.gaugeGraphs1} {...defaultProps} index="1" />
                            </div>
                            </Card>
                        </Col>
                    </Row>
                    <Row>
                        <Col style={{ padding: "0.5%", paddingTop: "20px" }}>
                            ...
                            <Card className="fieldset-chart">
                            <legend className="boxShw" id="5dd212491cda8" style={{overflow:"hidden"}}>Insolation Curve_20MW DCR</legend>
                            <div style={{width:"95%",margin:"auto"}}>
                    ...
                    {this.state.popupGraph && <ModelPopUp title={this.state.popupGraph.graphName}
                            id="popUpModal"
                            bodyContent={this.state.popupGraph && this.state.popupGraph.series ? <InsolutionCurveChart {...this.state.popupGraph} {...defaultProps} onDoubleClickEvent={null} /> :
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(InsolutionCurve));

//export default InsolutionCurve;