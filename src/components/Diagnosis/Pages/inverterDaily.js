...
class InverterToday extends Component {
    ...
    componentDidMount() {
        this.props.getMakeGraph({ pageID: 1, subPageID: 8 });
    }
                ...
                <Card style={{ maxWidth: "1264px", margin: "auto" }}>
                    ...
                    <Row>
                        <Col style={{ padding: "0.5%", paddingTop: "20px" }}>
                            ...
                            <legend className="boxShw" id="5dd212491cda8" style={{overflow:"hidden"}}>DLF Hyderabad_519 Kw- Daily generation</legend>
                        ...
                        <Col style={{ padding: "0.5%", paddingTop: "20px" }}>
                            ...
                            <Card className="fieldset-chart">
                            <legend className="boxShw" id="5dd212491cda8" style={{overflow:"hidden"}}>Inverter Today</legend>
                            <div style={{width:"95%",margin:"auto"}}>
