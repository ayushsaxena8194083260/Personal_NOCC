...
import PowerImportedCharts from "../Charts/powerImportedChart";
...
class PowerImported extends Component {
    constructor(props) {
        super(props)
        this.state = {
                ...
                <Card style={{ maxWidth: "1264px", margin: "auto" }}>
                    ...
                    <Row>
                        <Col style={{ padding: "0.5%", paddingTop: "20px" }}>
                            ...
                            <legend className="boxShw" id="5dd212491cda8" style={{overflow:"hidden"}}>Power Imported_40MW Open</legend>
                            <div style={{width:"95%",margin:"auto"}}>
                                <PowerImportedCharts {...this.state.gaugeGraphs0} {...defaultProps} index="0" />
                            </div>
                            </Card>
                        </Col>
                        <Col style={{ padding: "0.5%", paddingTop: "20px" }}>
                            ...
                            <Card className="fieldset-chart">
                            <legend className="boxShw" id="5dd212491cda8" style={{overflow:"hidden"}}>Power Imported_40MW DCR</legend>
                            <div style={{width:"95%",margin:"auto"}}>
                            <PowerImportedCharts {...this.state.gaugeGraphs1} {...defaultProps} index="1" />
                            </div>
                            </Card>
                        </Col>
                    </Row>
                    <Row>
                        <Col style={{ padding: "0.5%", paddingTop: "20px" }}>
                            ...
                            <Card className="fieldset-chart">
                            <legend className="boxShw" id="5dd212491cda8" style={{overflow:"hidden"}}>Power Imported_20MW DCR</legend>
                            <div style={{width:"95%",margin:"auto"}}>
                            <PowerImportedCharts {...this.state.gaugeGraphs2} {...defaultProps} index="2" />
                            </div>
                            </Card>
                        </Col>
                        <Col style={{ padding: "0.5%", paddingTop: "20px" }}>
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(PowerImported));
