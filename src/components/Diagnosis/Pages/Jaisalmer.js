...
class Jaisalmer extends Component {
    constructor(props) {
        super(props)
        this.state = {
    ...
    componentDidMount() {
        this.props.getMakeGraph({ pageID: 1, subPageID: 5 });
    }
                ...
                <Card style={{ maxWidth: "1264px", margin: "auto" }}>
                    ...
                    <Row>
                        <Col style={{ padding: "0.5%", paddingTop: "20px" }}>
                            ...
                            <legend className="boxShw" id="5dd212491cda8" style={{overflow:"hidden"}}>RAJASTHAN 4 - DAILY GENERATION</legend>
                        ...
                        <Col style={{ padding: "0.5%", paddingTop: "20px" }}>
                            ...
                            <Card className="fieldset-chart">
                            <legend className="boxShw" id="5dd212491cda8" style={{overflow:"hidden"}}>Units Imported- Jaisalmer 5 MW</legend>
                            <div style={{width:"95%",margin:"auto"}}>
                    ...
                    <Row>
                        <Col style={{ padding: "0.5%", paddingTop: "20px" }}>
                            ...
                            <Card className="fieldset-chart">
                            <legend className="boxShw" id="5dd212491cda8" style={{overflow:"hidden"}}>Insolation-Jaisalmer 5 MW</legend>
                            <div style={{width:"95%",margin:"auto"}}>
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(Jaisalmer));
