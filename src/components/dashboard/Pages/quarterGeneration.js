...
import { makeGraphfgauge } from '../../../actions/action-makeGraphfgauge';
...
class QuarterGeneration extends Component {
    constructor(props) {
        super(props);
                    ...
                    <Card.Body style={{ padding: "0", height: "550px", overflow: "auto" }}>
                        <Row>
                            ...
                            <Col lg={6} md={6} sm={12} style={{ display: "inline-block", padding: "0.5%", float: "right", paddingTop: "20px" }}>
                                ...
                                <Card className="fieldset-chart">
                                    <legend className="boxShw1" id="5dd212491cda8" style={{ overflow: "hidden" }}>Quarter 2 Generation</legend>
                                    <div style={{ width: "95%", margin: "auto" }}>
                        ...
                        <Row>
                            <Col lg={6} md={6} sm={12} style={{ padding: "0.5%", paddingTop: "20px" }}>
                                ...
                                <Card className="fieldset-chart">
                                    <legend className="boxShw" id="5dd212491cda8" style={{ overflow: "hidden" }}>Quarter 3 Generation</legend>
                                    <div style={{ width: "95%", margin: "auto" }}>
                                    ...
                                    <Row>
                                        <Col lg={4} md={4} sm={12} style={{ border: '0.1px solid #77777726' }}>
                                            {this.state.gaugeGraphs20 && this.state.gaugeGraphs20.series ? <GaugeSpeedoMeter {...this.state.gaugeGraphs20} id="986" /> :
                            ...
                            <Col lg={6} md={6} sm={12} style={{ display: "inline-block", padding: "0.5%", float: "right", paddingTop: "20px" }}>
                                ...
                                <Card className="fieldset-chart">
                                    <legend className="boxShw1" id="5dd212491cda8" style={{ overflow: "hidden" }}>Quarter 4 Generation</legend>
                                    <div style={{ width: "95%", margin: "auto" }}>
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(QuarterGeneration));
