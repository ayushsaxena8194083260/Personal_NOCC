...
export default {
    exportCsv(response) {
        let fstArray = [];
        if ((parseInt(response.graphId) == 866) || (parseInt(response.graphId) == 867) || (parseInt(response.graphId) == 888) ||
        (parseInt(response.graphId) == 407) || (parseInt(response.graphId) == 408) || (parseInt(response.graphId) == 409) ||
        (parseInt(response.graphId) == 411) || (parseInt(response.graphId) == 412) || (parseInt(response.graphId) == 413) || 
        (parseInt(response.graphId) == 429) || (parseInt(response.graphId) == 430) || (parseInt(response.graphId) == 432) ||
        (parseInt(response.graphId) == 433) || (parseInt(response.graphId) == 440) || (parseInt(response.graphId) == 437) ||
        (parseInt(response.graphId) == 855) || (parseInt(response.graphId) == 795) || (parseInt(response.graphId) == 381) ||
        (parseInt(response.graphId) == 1001) ){          
        let outputArray = []; 
