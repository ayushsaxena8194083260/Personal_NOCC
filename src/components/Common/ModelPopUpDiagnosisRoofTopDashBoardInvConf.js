...
import { getMakeGraph} from '../../actions/action-RooftopDashboard';
import { BrowserRouter, withRouter } from 'react-router-dom';
import { connect } from 'react-redux';
import LineBasicChart from '../Charts/lineBasic';
import Loader from 'react-loader-spinner';
import exportCsv from './exportToCsvRoofTopDashboardInvertConf';
import exportFromJSON from 'export-from-json';
// import { getMakeGraphGauge } from '../../../actions/action-MakeGraphRoofTopInverterConf';

class ModelPopUpRTDBINVCONF extends Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    getGraph(){
        let defaultprops = {
            ...
            "graphId": this.props.apiResponse.graphId,
            "plant": [
...
const mapStateToProps = state => {
    return {
        ...
        gaugeGraphs0: state.ChartsReducer.graphs0,
    }
}
...
export default withRouter(connect(mapStateToProps,mapDispatchToProps)(ModelPopUpRTDBINVCONF));
