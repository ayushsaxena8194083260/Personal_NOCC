...
class MonthlyPmCheckList extends Component {
                    ...
                    <Card.Body>
                        ...
                        <div id="pMLIstTable" class="pMLIstTable">
                            <div style={{ width: "780px", margin: "10px 20px" }}>
                                ...
                                <h2 style={{ textAlign: "center", fontFamily: "serif", fontWeight: "700", color: "rgb(62, 64, 105)" }}>Monthly Preventive Maintenance Tasks</h2>
                                                    ...
                                                    <>
                                                        ...
                                                        {taskGroupDetails.map((taskGroupPerId, key1) => (
                                                            <tr>
                                                                ...
                                                                <td width="25%">
                                                                    <input
                                                                        type={taskGroupPerId.pmStatusInputType}
                                                                        class="pm-task-text"
                                                                        name="task_status-1"
                                                                        value={taskGroupPerId.pm_remark_status.pmStatus}
                                                                ...
                                                                <td width="8%">
                                                                    <input
                                                                        type={taskGroupPerId.pmCheckedInputType}
                                                                        name={'checked-' + (key + 1)}
                                                                        value={taskGroupPerId.pm_remark_status.pmChecked}
                                                                        checked={taskGroupPerId.pm_remark_status.pmChecked}
                                                                    />
                                                                </td>
                                                                <td>
                                                                    <textarea
                                                                        ...
                                                                        cols="6"
                                                                        name="remarks-1"
                                                                        value={taskGroupPerId.pm_remark_status.pmRemarks}>
                                                                    </textarea>
                                                                </td>
                                                            </tr>
                                                        ))}
...
export default MonthlyPmCheckList;