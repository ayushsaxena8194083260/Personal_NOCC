...
class BimonthlyPmCheckList extends Component{
    ...
    render(){
        return(
            ...
            <div style={{width:"780px",margin:"10px 20px"}}>
                ...
                <h2 style={{textAlign:"center",fontFamily:"serif",fontWeight: "700",color:"rgb(62, 64, 105)"}}>BiMonthly Preventive Maintenance Tasks</h2>
...
export default BimonthlyPmCheckList;