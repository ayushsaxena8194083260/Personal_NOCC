...
class HalfYearlyPmCheckList extends Component{
        ...
        render() {
            return (
                ...
                <div style={{width:"780px",margin:"10px 20px"}}>
                    ...
                    <h2 style={{textAlign:"center",fontFamily:"serif",fontWeight: "700",color:"rgb(62, 64, 105)"}}>Half Yearly Preventive Maintenance Tasks</h2>
                    ...
                    <form method="post" action="https://nocc.azurepower.com/preventivemaintainance/addTaskStatus" name="Save">
                        ...
                        <td colspan="4"><textarea rows="10" cols="10" name="special-remarks" value={this.state.userStatusDetails[0].specialRemarks}></textarea></td></tr>
                                    <tr><td colspan="7"><b>Prepared by:  <br/> <b>Name : {this.state.userStatusDetails[0].userName}i</b><br/>Date:  {this.state.userStatusDetails[0].createdDate} </b><br/>
...
export default HalfYearlyPmCheckList;