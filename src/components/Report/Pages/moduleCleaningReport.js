...
import { getAllModuleCleaning } from '../../../actions/action-Report';
import { connect } from 'react-redux'
// import * as FileSaver from 'file-saver';
// import * as XLSX from 'xlsx';
import exportFromJSON from 'export-from-json';

class ModuleCleaningReport extends Component {
    ...
    downloadData() {
        this.props.getAllModuleCleaning({ plantIds: [this.state.selectedPlantOptions], fromDate: this.state.selectedFromDate, toDate: this.state.selectedToDate });
        //this.state.reportData && this.state.reportData.length > 0 && this.exportToCSV(this.state.reportData, "ModuleCLeaning");
    }
            ...
            <div>
                ...
                <div className="top-filter">
                    <div className="row" style={{ alignItems: "center", margin: "0" }} >
                        ...
                        <Col lg={1} md={1} sm={6} className="input_group">
                        ...
                        <Col className="input_group" lg={1} md={1} sm={6}>
...
const mapDispatchToProps = (dispatch) => {
    return {
        ...
        getAllModuleCleaning: (data) => dispatch(getAllModuleCleaning(data))
    }
}

export default withRouter(connect(mapStateToProps, mapDispatchToProps)(ModuleCleaningReport));