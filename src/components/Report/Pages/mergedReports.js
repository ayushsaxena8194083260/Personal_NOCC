...
import {getMergedExcelReport} from '../../../actions/action-Report';
...
class MergedReports extends Component{
    ...
    downloadData(){
        this.props.getMergedExcelReport({plant_id:this.state.selectedPlantOptions,fromDate:this.state.selectedFromDate,toDate:this.state.selectedToDate});
        //this.state.reportData && this.state.reportData.length > 0 && this.exportToCSV(this.state.reportData, "MergedReport");        
    }
        ...
        <div>
            ...
            <div className="top-filter">
                ...
                <Col  lg={2} md={2} sm={6} className="large_percent_width">
                                ...
                                <Button type="button" className="btn btn-primary view_button"
                       size="lg" style={{width:"100%"}} onClick = {() => this.downloadData()}>Download</Button>
                    </Col>
            </Row>
...
const mapDispatchToProps = (dispatch) => {
    return {
        ...
        getMergedExcelReport:(data) => dispatch(getMergedExcelReport(data))
    }
}

export default withRouter(connect(mapStateToProps, mapDispatchToProps)(MergedReports));