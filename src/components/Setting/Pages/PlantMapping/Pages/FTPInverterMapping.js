...
class FTPInverterMapping extends Component{
    constructor(props) {
        super(props);
        this.state = {
    ...
    getRenderFTPInvMapping() {
        ...
        plantIds.length > 0 && this.props.getFTPPlantMappingWithType({ plantIds: plantIds, type:"INV"});
        // this.props.getFTPPlantMappingWithType({ plantIds: [this.state.selectedPlantOptions] });
    ...
    render() {
        ...
        const fileName = 'Inverter_Mapping_List_Report_'
            ...
            <div>
                <div className="top-filter">
                    ...
                    <Col xs={1} style={{ maxWidth: "5%" }}>
                        ...
                        <Col xs={2} style={{ maxWidth: "7%" }}>
                            <button type="button" className="btn btn-orange" onClick={() => this.getRenderFTPInvMapping()}>
                                Go
                        </button>
                        </Col>
                        <Col xs={2} style={{maxWidth:"13%"}}>
                        <Route render={({ history }) => (
                                <button type="button" className="btn btn-primary" style={{ width: "100%" }} plantName={this.state.selectedPlantOptions} plantType={this.state.selectedPlanType} onClick={() => { history.push('/setting/FTPInverterMappingEdit') }}>
                                    <img src="/images/icons/fugue/plus-circle.png" alt="add plant" title="Add Inverter" style={{ float: "left", marginRight: "3" }} />
                                    Add Inverter
                        </button>)} />
                        </Col>
                        <Col xs={2} style={{maxWidth:"13%"}}>
                ...
                <div
                    ...
                    <ModelPopUp title="Delete"
                            ...
                            bodyContent="Are you sure want to delete this FTP Inverter Mapping?"
...
const mapStateToProps = (state, props) => {
    return {
        ...
        alternateAdapter: [{adapterName: "csvImportAdapter", value:"1"},{adapterName: "csvImportAdapterRoofTop", value:"2"},
...
export default withRouter(connect(mapStateToProps,mapDispatchToProps)(FTPInverterMapping));