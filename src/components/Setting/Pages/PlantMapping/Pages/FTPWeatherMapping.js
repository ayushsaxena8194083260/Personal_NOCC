    ...
    render() {
        return (<div className="products-actions">
            <Link className="products-actions-link"
                to={{
                    pathname: "/setting/FTPWeatherMappingEdit",
                    ftpWethMapp: this.props.data,
...
class FTPWeatherMapping extends Component{
    constructor(props) {
        super(props);
        this.state = {
    ...
    getRenderInverterConfiguration() {
        ...
        plantIds.length > 0 && this.props.getFTPPlantMappingWithType({ plantIds: plantIds, type:"WED"});
    ...
    render() {
        ...
        const fileName = 'Weather_Mapping_List_Report_'
            ...
            <div>
                ...
                <div
                    ...
                    <ModelPopUp title="Delete"
                            ...
                            bodyContent="Are you sure want to delete this FTP Weather Mapping?"
...
export default withRouter(connect(mapStateToProps,mapDispatchToProps)(FTPWeatherMapping));