...
class WeatherConfigurationEdit extends Component {
    constructor(props) {
        super(props);
        this.state = {
            ...
            plantId: this.props.location && this.props.location.WeatherConfiguration.plantId? this.props.location.WeatherConfiguration.plantId : null,
                    ...
                    <Card className="add-fault-card">
                        ...
                        <Card.Body>
                            ...
                            <Row>
                                ...
                                <Col>
                                    <Form.Control name="weatherStationSerialNumber" type="text" onChange={(item) => this.handleChange(item)} value={this.state.postData.weatherStationSerialNumber && this.state.postData.weatherStationSerialNumber ? this.state.postData.weatherStationSerialNumber : null} />
                            ...
                            <Row>
                                ...
                                <Col>
                                    <Form.Control name="weatherStationNumber" type="text" onChange={(item) => this.handleChange(item)} value={this.state.postData.weatherStationNumber  && this.state.postData.weatherStationNumber ? this.state.postData.weatherStationNumber : null} />
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(WeatherConfigurationEdit));