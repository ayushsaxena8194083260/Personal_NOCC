...
import {getWeatherCSVMappingConfiguration, clearSettingPlantMapping, deleteCSVWeatherMap} from '../../../../../actions/action-Settings';
...
class ActionCellRenderer extends React.Component {
    ...
    invokeDelete() {
        this.props.context.componentParent.onDelete(this.props.node.data.csvWeatherId);
    }
    render() {
        return (<div className="products-actions">
            <Link className="products-actions-link"
                to={{
                    pathname: "/setting/WeatherCSVMappingEdit",
                    weatherCSVMapp: this.props.data
                }}>
...
class WeatherCSVMapping extends Component{
    constructor(props) {
        super(props);
        this.state = {
    ...
    getRenderInverterConfiguration() {
        ...
        plantIds.length > 0 && this.props.getWeatherCSVMappingConfiguration({ plantIds: plantIds});

        // this.props.getWeatherCSVMappingConfiguration({ plantIds: [this.state.selectedPlantOptions] });
    ...
    deleteRecord() {
        if (this.state.deleteID !== null) {
            this.props.deleteCSVWeatherMap(this.state.deleteID);
            this.onHide();
        }
    }
            ...
            <div>
                <div className="top-filter">
                    ...
                    <Col xs={1} style={{ maxWidth: "5%" }}>
                        ...
                        <Route render={({ history }) => (
                            <button type="button" class="btn btn-primary" style={{ width: "100%" }} onClick={() => { history.push('/setting/WeatherCSVMappingEdit') }}>
                ...
                <div
                    ...
                    <ModelPopUp title="Delete"
                            id={"WeatherCSVMappingDelete"}
                            bodyContent="Are you sure want to delete this Weather CSV Mapping?"
...
const mapDispatchToProps = (dispatch) => {
    return {
        getWeatherCSVMappingConfiguration:(plantIds) => dispatch(getWeatherCSVMappingConfiguration(plantIds)),
        ...
        deleteCSVWeatherMap: (id) => dispatch(deleteCSVWeatherMap(id))
    }
}
export default withRouter(connect(mapStateToProps,mapDispatchToProps)(WeatherCSVMapping));