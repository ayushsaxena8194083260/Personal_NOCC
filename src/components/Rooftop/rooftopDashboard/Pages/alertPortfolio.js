...
class AlertPorfolia extends Component {
    constructor(props) {
        super(props);
        this.state = {
            graphs0: [],
    ...
    componentWillReceiveProps(nextProps) {
        ...
        console.log('nextProps.graphs1', nextProps.graphs1)
    }
                    ...
                    <Card.Body style={{ padding: "0", height: "550px", overflow: "auto" }}>
                        <Row>
                            <Col style={{ padding: "0.5%", paddingTop: "20px" }}>
                                ...
                                <Card className="fieldset-chart">
                                    <legend className="boxShw" id="5dd212491cda8" style={{ overflow: "hidden" }}>Alert Portfolio Daily - Rooftop</legend>
                                    <div style={{ width: "95%", margin: "auto" }}>

                                        {this.state.graphs0 && this.state.graphs0.series ? <AlertPortfolioCharts {...this.state.graphs0} {...defaultProps} index="0" /> :
                            ...
                            <Col style={{ padding: "0.5%", paddingTop: "20px" }}>
                                ...
                                <Card className="fieldset-chart">
                                    <legend className="boxShw" id="5dd212491cda8" style={{ overflow: "hidden" }}>Alert Portfolio MTD - Rooftop</legend>
                                    <div style={{ width: "95%", margin: "auto" }}>
                                        {this.state.graphs1 && this.state.graphs1.series ? <AlertPortfolioCharts {...this.state.graphs1} {...defaultProps} index="1" /> :
                                            <Loader type="Watch" color="#00BFFF" height={80} width={80} />}
                                    </div>
                                </Card>
                            </Col>
                        ...
                        <Row>
                            <Col style={{ padding: "0.5%", paddingTop: "20px" }}>
                                ...
                                <Card className="fieldset-chart">
                                    <legend className="boxShw" id="5dd212491cda8" style={{ overflow: "hidden" }}>Alert Portfolio QTD - Rooftop</legend>
                                    <div style={{ width: "95%", margin: "auto" }}>
                                        {this.state.graphs2 && this.state.graphs2.series ? <AlertPortfolioCharts {...this.state.graphs2} {...defaultProps} index="2" /> :
                                            <Loader type="Watch" color="#00BFFF" height={80} width={80} />}
                                        {/* <AlertPortfolioCharts {...this.state.graphs2}/> */}
                                    </div>
                                </Card>
                            </Col>
                            <Col style={{ padding: "0.5%", paddingTop: "20px" }}>
                                ...
                                <Card className="fieldset-chart">
                                    <legend className="boxShw" id="5dd212491cda8" style={{ overflow: "hidden" }}>Alert Portfolio YTD - Rooftop</legend>
                                    <div style={{ width: "95%", margin: "auto" }}>
                                        {this.state.graphs3 && this.state.graphs3.series ? <AlertPortfolioCharts {...this.state.graphs3} {...defaultProps} index="3" /> :
                                            <Loader type="Watch" color="#00BFFF" height={80} width={80} />}
                                        {/* <AlertPortfolioCharts {...this.state.graphs3}/> */}
                                    </div>
                                </Card>
                            </Col>
                        </Row>
                        {this.state.popupGraph && <ModelPopUpRTDBINVCONF title={this.state.popupGraph.graphName}
                            id="popUpModal"
                            bodyContent={this.state.popupGraph && this.state.popupGraph.series ? <AlertPortfolioCharts {...this.state.popupGraph} {...defaultProps} onDoubleClickEvent={null} /> :
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(AlertPorfolia));
