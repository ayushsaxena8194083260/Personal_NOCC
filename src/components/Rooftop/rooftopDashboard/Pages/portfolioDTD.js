                        ...
                        <Row>
                            <Col style={{ padding: "0.5%", paddingTop: "20px" }}>
                                ...
                                <Card className="fieldset-chart">
                                    <legend className="boxShw" id="5dd212491cda8" style={{ overflow: "hidden" }}>YTD Alerts - Hubwise - Rooftop</legend>
                                    <div style={{ width: "95%", margin: "auto" }}>

                                        {this.state.graphs0 && this.state.graphs0.series ? <PortfolioDTDCharts {...this.state.graphs0} {...defaultProps} index="0" /> :
                            ...
                            <Col style={{ padding: "0.5%", paddingTop: "20px" }}>
                                ...
                                <Card className="fieldset-chart">
                                    <legend className="boxShw" id="5dd212491cda8" style={{ overflow: "hidden" }}>Inverter Efficiency</legend>
                                    <div style={{ width: "95%", margin: "auto" }}>
