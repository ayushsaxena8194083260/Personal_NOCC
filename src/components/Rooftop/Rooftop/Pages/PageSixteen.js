...
class PageSixteen extends Component { 
    ...
    componentDidMount(){
        ...
        let inputParams = { pageID: 1, subPageID: 16};
            ...
            <Card style={{ maxWidth: "1264px", margin: "auto" }}>
                ...
                <Row>
                    <Col style={{ padding: "0.5%", paddingTop: "20px" }}>
                        ...
                        <legend className="boxShw" id="5dd212491cda8" style={{overflow:"hidden"}}>E Today_Inverter_DMRC-Amity-noida</legend>
                    ...
                    <Col style={{ padding: "0.5%", paddingTop: "20px" }}>
                        ...
                        <Card className="fieldset-chart">
                        <legend className="boxShw" id="5dd212491cda8" style={{overflow:"hidden"}}>E Today_Inverter_DMRC-Botanical-garden</legend>
                        <div style={{width:"95%",margin:"auto"}}>
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(PageSixteen));