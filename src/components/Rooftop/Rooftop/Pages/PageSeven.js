            ...
            <Card style={{ maxWidth: "1264px", margin: "auto" }}>
                ...
                <Row>
                    <Col style={{ padding: "0.5%", paddingTop: "20px" }}>
                        ...
                        <legend className="boxShw" id="5dd212491cda8" style={{overflow:"hidden"}}>E Total_Inverter_PEDA-C A Vegefruit Stores_0.598 MW</legend>
                    ...
                    <Col style={{ padding: "0.5%", paddingTop: "20px" }}>
                        ...
                        <Card className="fieldset-chart">
                        <legend className="boxShw" id="5dd212491cda8" style={{overflow:"hidden",width:"40%"}}>E Total_Inverter_PEDA- Skyross Enterprises_1.253 MW</legend>
                        <div style={{width:"95%",margin:"auto"}}>
                ...
                <Row>
                    <Col style={{ padding: "0.5%", paddingTop: "20px" }}>
                        ...
                        <Card className="fieldset-chart">
                        <legend className="boxShw" id="5dd212491cda8" style={{overflow:"hidden",width:"50%"}}>E Total_Inverter_	PEDA-Bhagwant Singh & Kulwinder Kaur warehouse- 0.550 MW</legend>
                        <div style={{width:"95%",margin:"auto"}}>
                    ...
                    <Col style={{ padding: "0.5%", paddingTop: "20px" }}>
                        ...
                        <Card className="fieldset-chart">
                        <legend className="boxShw" id="5dd212491cda8" style={{overflow:"hidden"}}>E Total_Inverter_PSAMB Ludhiana_0.762 MW</legend>
                        <div style={{width:"95%",margin:"auto"}}>
                            <InverterGenerationBar {...this.state.gaugeGraphs3}/>
                        </div>
                        </Card>
                    </Col>
                </Row>
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(PageSeven));