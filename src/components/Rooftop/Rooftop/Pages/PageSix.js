                ...
                <Card style={{ maxWidth: "1264px", margin: "auto" }}>
                    ...
                    <Row>
                        <Col style={{ padding: "0.5%", paddingTop: "20px" }}>
                            ...
                            <legend className="boxShw" id="5dd212491cda8" style={{overflow:"hidden"}}>E Total_Inverter_PEDA SAS NAGAR</legend>
                        ...
                        <Col style={{ padding: "0.5%", paddingTop: "20px" }}>
                            ...
                            <Card className="fieldset-chart">
                            <legend className="boxShw" id="5dd212491cda8" style={{overflow:"hidden",width:"40%"}}>E Total_Inverter_PEDA-Bhagwant Singh & Others_ 1.304 MW</legend>
                            <div style={{width:"95%",margin:"auto"}}>
                    ...
                    <Row>
                        <Col style={{ padding: "0.5%", paddingTop: "20px" }}>
                            ...
                            <Card className="fieldset-chart">
                            <legend className="boxShw" id="5dd212491cda8" style={{overflow:"hidden"}}>E Total_Inverter_PEDA-BOSS Computers_1.250 MW</legend>
                            <div style={{width:"95%",margin:"auto"}}>
                        ...
                        <Col style={{ padding: "0.5%", paddingTop: "20px" }}>
                            ...
                            <Card className="fieldset-chart">
                            <legend className="boxShw" id="5dd212491cda8" style={{overflow:"hidden"}}>E Total_Inverter_PEDA- PSAMB Mansa_0.630 MW</legend>
                            <div style={{width:"95%",margin:"auto"}}>
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(PageSix));