...
class PageSeventeen extends Component {
    constructor(props) {
        super(props);
        this.state={
    ...
    componentDidMount(){
        ...
        let inputParams = { pageID: 1, subPageID: 18};
            ...
            <Card style={{ maxWidth: "1264px", margin: "auto" }}>
                ...
                <Row>
                    <Col style={{ padding: "0.5%", paddingTop: "20px" }}>
                        ...
                        <legend className="boxShw" id="5dd212491cda8" style={{overflow:"hidden"}}>E Today_Inverter_DMRC-Jamia-Nagar</legend>
                    ...
                    <Col style={{ padding: "0.5%", paddingTop: "20px" }}>
                        ...
                        <Card className="fieldset-chart">
                        <legend className="boxShw" id="5dd212491cda8" style={{overflow:"hidden"}}>E Today_Inverter_DMRC-Shankar-Vihar</legend>
                        <div style={{width:"95%",margin:"auto"}}>
                ...
                <Row>
                    {/* <Col style={{ padding: "0.5%", paddingTop: "20px" }}>
                        ...
                        <Card className="fieldset-chart">
                        <legend className="boxShw" id="5dd212491cda8" style={{overflow:"hidden"}}>E Today_Inverter_Aerocity</legend>
                        <div style={{width:"95%",margin:"auto"}}>
                            <InverterGenerationBar/>
                        </div>
                        </Card>
                    </Col>
                    <Col style={{ padding: "0.5%", paddingTop: "20px" }}>
                        ...
                        <Card className="fieldset-chart">
                        <legend className="boxShw" id="5dd212491cda8" style={{overflow:"hidden"}}>E Today_Inverter_Dhaula Kaun</legend>
                        <div style={{width:"95%",margin:"auto"}}>
                            <InverterGenerationBar/>
                        </div>
                        </Card>
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(PageSeventeen));