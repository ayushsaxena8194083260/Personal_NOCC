...
class PageFifteen extends Component { 
    ...
    componentDidMount(){
        ...
        let inputParams = { pageID: 1, subPageID: 15};
            ...
            <Card style={{ maxWidth: "1264px", margin: "auto" }}>
                ...
                <Row>
                    <Col style={{ padding: "0.5%", paddingTop: "20px" }}>
                        ...
                        <legend className="boxShw" id="5dd212491cda8" style={{overflow:"hidden"}}>E Today_Inverter_Utkal University</legend>
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(PageFifteen));