...
class PageTwelve extends Component { 
    ...
    componentDidMount(){
        ...
        let defaultprops = {
          ...
          let inputParams = { pageID: 1, subPageID: 12};
            ...
            <Card style={{ maxWidth: "1264px", margin: "auto" }}>
                ...
                <Row>
                    <Col style={{ padding: "0.5%", paddingTop: "20px" }}>
                        ...
                        <legend className="boxShw" id="5dd212491cda8" style={{overflow:"hidden"}}>E Today_Inverter_DwarkaCourt</legend>
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(PageTwelve));