...
class PageFourteen extends Component { 
    ...
    componentDidMount(){
        ...
        let inputParams = { pageID: 1, subPageID: 14};
            ...
            <Card style={{ maxWidth: "1264px", margin: "auto" }}>
                ...
                <Row>
                    <Col style={{ padding: "0.5%", paddingTop: "20px" }}>
                        ...
                        <legend className="boxShw" id="5dd212491cda8" style={{overflow:"hidden"}}>E Today_Inverter_Okhla VIhar</legend>
                    ...
                    <Col style={{ padding: "0.5%", paddingTop: "20px" }}>
                        ...
                        <Card className="fieldset-chart">
                        <legend className="boxShw" id="5dd212491cda8" style={{overflow:"hidden"}}>E Today_Inverter_Jasola Vihar</legend>
                        <div style={{width:"95%",margin:"auto"}}>
                ...
                <Row>
                    <Col style={{ padding: "0.5%", paddingTop: "20px" }}>
                        ...
                        <Card className="fieldset-chart">
                        <legend className="boxShw" id="5dd212491cda8" style={{overflow:"hidden"}}>E Today_Inverter_Khyber Pas</legend>
                        <div style={{width:"95%",margin:"auto"}}>
                    ...
                    <Col style={{ padding: "0.5%", paddingTop: "20px" }}>
                        ...
                        <Card className="fieldset-chart">
                        <legend className="boxShw" id="5dd212491cda8" style={{overflow:"hidden"}}>E Today_Inverter_DMRC-Kalindi-Kunj</legend>
                        <div style={{width:"95%",margin:"auto"}}>
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(PageFourteen));