...
class PageSeventeen extends Component { 
    ...
    componentDidMount(){
        ...
        let inputParams = { pageID: 1, subPageID: 17};
            ...
            <Card style={{ maxWidth: "1264px", margin: "auto" }}>
                ...
                <Row>
                    <Col style={{ padding: "0.5%", paddingTop: "20px" }}>
                        ...
                        <legend className="boxShw" id="5dd212491cda8" style={{overflow:"hidden"}}>E Today_Inverter_Shivaji Stadium</legend>
                    ...
                    <Col style={{ padding: "0.5%", paddingTop: "20px" }}>
                        <Card className="fieldset-chart">
                        <legend className="boxShw" id="5dd212491cda8" style={{overflow:"hidden"}}>E Today_Inverter_New Delhi</legend>
                        <div style={{width:"95%",margin:"auto"}}>
