...
class PageNinteen extends Component {
    constructor(props) {
        super(props);
        this.state={
    ...
    componentDidMount(){
        ...
        let inputParams = { pageID: 1, subPageID: 19};
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(PageNinteen));