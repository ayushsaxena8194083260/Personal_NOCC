...
import { deleteExternalBudget } from "../actions/action-ExternalBudget";
import ExternalBudget from "./../components/ExternalBudget/externalBudget";
import {clearExternalBudgetData} from "../actions/action-ExternalBudget";
import {getExternalBudgetByYear} from "../actions/action-ExternalBudget"
...
const mapDispatchToProps = (dispatch) => {
    return {
        ...
        deleteExternalBudget: (fault_id) => dispatch(deleteExternalBudget(fault_id)),
        clearExternalBudgetData:() =>dispatch(clearExternalBudgetData()),
        getExternalBudgetByYear:(data)=> dispatch(getExternalBudgetByYear(data)),
    }
}

const ExternalBudgetContainer = withRouter(connect(mapStateToProps, mapDispatchToProps)(ExternalBudget));
